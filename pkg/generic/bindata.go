...
// pkg/generic/iterator/generator.go
...
var _iteratorGeneratorGo = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x2a\x48\x4c\xce\x4e\x4c\x4f\x55\xc8\x2c\x49\x2d\x4a\x2c\xc9\x2f\xe2\x02\x04\x00\x00\xff\xff\x2c\x77\x43\xf2\x11\x00\x00\x00")

func iteratorGeneratorGoBytes() ([]byte, error) {
	return bindataRead(
		_iteratorGeneratorGo,
		"iterator/generator.go",
	)
}

func iteratorGeneratorGo() (*asset, error) {
	bytes, err := iteratorGeneratorGoBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "iterator/generator.go", size: 17, mode: os.FileMode(420), modTime: time.Unix(1585743846, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func iteratorIteratorGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "iterator/iterator.go", size: 846, mode: os.FileMode(420), modTime: time.Unix(1585743867, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"iterator/generator.go": iteratorGeneratorGo,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"iterator": &bintree{nil, map[string]*bintree{
		"generator.go": &bintree{iteratorGeneratorGo, map[string]*bintree{}},
